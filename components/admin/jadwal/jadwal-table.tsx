        ...
        <div className="bg-white p-6 mt-6 rounded-lg shadow-sm border border-gray-100 overflow-x-auto">
            ...
            <table className="w-full divide-y divide-gray-200 text-left">
                <thead className="bg-gray-50">
                    <tr>
                        <th className="px-4 py-3 text-xs font-semibold text-gray-600 uppercase tracking-wider text-left">#</th>
                        ...
                        <tr>
                            <td colSpan={10} className="py-10 text-center">
                                <div className="flex flex-col items-center justify-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-md font-medium text-gray-600">Memuat data jadwal</h3>
                                ...
                                <td className="px-4 py-3 text-sm text-gray-700">
                                    <div className="flex justify-start space-x-2">
                                        <Tooltip content="Edit">
                                            <button onClick={() => redirect(`/dashboard/data-jadwal/edit/${jadwal.id}`)} className="bg-blue-600 hover:bg-blue-700 p-2 rounded-md transition-colors">
                                                <FaEdit className="w-4 h-4 text-white" />
                                            </button>
                                        </Tooltip>
                                        <Tooltip content="Hapus">
                                            <button onClick={() => setDeleteId(jadwal.id)} className="bg-red-600 hover:bg-red-700 p-2 rounded-md transition-colors">
