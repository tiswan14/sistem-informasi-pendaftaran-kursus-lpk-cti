                                ...
                                <td className="text-center">
                                    <div className="flex items-center justify-center">
                                        <button
                                            ...
                                            className="cursor-pointer flex items-center gap-2 px-3 py-2 rounded-lg bg-blue-50 hover:bg-blue-100 text-blue-600 transition-colors duration-200 shadow-sm hover:shadow-md"
                                        >
